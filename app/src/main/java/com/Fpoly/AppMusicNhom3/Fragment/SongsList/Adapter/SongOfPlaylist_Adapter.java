package com.Fpoly.AppMusicNhom3.Fragment.SongsList.Adapter;
...
public class SongOfPlaylist_Adapter extends RecyclerView.Adapter<SongOfPlaylist_Adapter.ViewHolder> {
    Context context;
    ArrayList<Song> songArrayList;
    SongsListFragment songsListFragment;

    public SongOfPlaylist_Adapter(Context context, ArrayList<Song> songArrayList, SongsListFragment songsListFragment) {
        ...
        alertDialog = new AlertDialog.Builder(context)
                ...
                .setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        playListDAO.removeItemPlayList(userInfor.getID(),userInfor.getTempPlayListID(),song.getID(), new SongCallBack() {
                            @Override
